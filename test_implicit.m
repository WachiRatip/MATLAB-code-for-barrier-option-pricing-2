...
N = 50;
[call, V] = implicit(S0,K,B,T,r,q,vola_alpha,N,100);
call

[call, V] = implicit(S0,K,B,T,r,q,vola_alpha,N,200);
call

[call, V] = implicit(S0,K,B,T,r,q,vola_alpha,N,300);
call

[call, V] = implicit(S0,K,B,T,r,q,vola_alpha,N,400);
call

[call, V] = implicit(S0,K,B,T,r,q,vola_alpha,N,500);
call
